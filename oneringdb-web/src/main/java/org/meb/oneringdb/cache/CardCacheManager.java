...
import org.meb.oneringdb.service.impl.DeckServiceImpl;
...
public class CardCacheManager {
	...
	// cache.get(getCardsKey()).getObjectValue();
	//
	...
	//
	// @SuppressWarnings("unchecked")
	// List<Card> warlordCards = (List<Card>)
	// warlordCardsElement.getObjectValue();
	// log.info("returning {} cards for warlord {}", warlordCards.size(),
	// warlordId);
	// return warlordCards;
	// }
}
